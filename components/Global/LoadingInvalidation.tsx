import {
  ...
  import { sending_invalidation } from "@/utils/dte";
  
  const LoadingInvalidation = ({ step }: { step: number }) => {
    return (
      <View style={styles.overlay}>
        ...
        <View style={styles.stepsContainer}>
          {sending_invalidation.map((ste, index) => (
  ...
  export default LoadingInvalidation;
